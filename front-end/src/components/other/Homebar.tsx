...
export default function Homebar(props: {loggedIn: boolean}) {
    ...
    const loginButton = () => {
        if (props.loggedIn === false) {
            return (
                <Link to="/profile/login" data-testid="LogInBtn">
    ...
    return (
        <nav className="flex items-center justify-between flex-wrap bg-sky-500 p-6">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <>
                <Link to="/" className="block mt-4 lg:inline-block lg:mt-0 text-sky-200 hover:text-white mr-4" data-testid="HomeBtn">
                    Home
                </Link>
                <Link to="/posts/search" className="block mt-4 lg:inline-block lg:mt-0 text-sky-200 hover:text-white mr-4" data-testid="SearchBtn">
                    Search
                </Link>
                {loginButton()}
                </>
